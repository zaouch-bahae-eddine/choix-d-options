...
return [
    ...
    'app_bloc_new_selected' => [['id', 'skillBloc'], ['_controller' => 'App\\Controller\\BlocController::newUE'], [], [['text', '/ue/new'], ['variable', '/', '[^/]++', 'skillBloc', true], ['text', '/bloc'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/parcour']], [], [], []],
