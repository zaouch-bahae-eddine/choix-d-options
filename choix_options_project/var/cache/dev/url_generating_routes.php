...
return [
    ...
    'app_bloc_new_ue_to_option' => [['id', 'skillBloc', 'optionBloc'], ['_controller' => 'App\\Controller\\BlocController::addUeToOptionBloc'], [], [['text', '/ue/add'], ['variable', '/', '[^/]++', 'optionBloc', true], ['text', '/optionBloc'], ['variable', '/', '[^/]++', 'skillBloc', true], ['text', '/bloc'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/parcour']], [], [], []],
    ...
    'app_bloc_ue_edit' => [['id', 'skillBloc', 'ue'], ['_controller' => 'App\\Controller\\BlocController::editUe'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'ue', true], ['text', '/ue'], ['variable', '/', '[^/]++', 'skillBloc', true], ['text', '/bloc'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/parcour']], [], [], []],
    'app_option_bloc_edit' => [['id', 'skillBloc', 'optionBloc'], ['_controller' => 'App\\Controller\\BlocController::editOptionBloc'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'optionBloc', true], ['text', '/optionBloc'], ['variable', '/', '[^/]++', 'skillBloc', true], ['text', '/bloc'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/parcour']], [], [], []],
