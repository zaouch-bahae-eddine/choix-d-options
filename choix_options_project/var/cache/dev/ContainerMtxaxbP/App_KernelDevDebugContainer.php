...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BlocController' => 'getBlocControllerService',
            'App\\Controller\\EtudiantController' => 'getEtudiantControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\ParcourController' => 'getParcourControllerService',
            'App\\Controller\\PromotionController' => 'getPromotionControllerService',
            'App\\Controller\\PromotionTestController' => 'getPromotionTestControllerService',
            'App\\Controller\\ResponsibleUserController' => 'getResponsibleUserControllerService',
            ...
            'App\\Controller\\UeController' => 'getUeControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/specshaper/encrypt-bundle/Twig/EncryptExtension.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/specshaper/encrypt-bundle/Encryptors/EncryptorInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/specshaper/encrypt-bundle/Encryptors/EncryptorFactory.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SdqAkFuCJb', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WmjltjNFTy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UYGn7W6k1A', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'SpecShaper\\EncryptBundle\\Subscribers\\DoctrineEncryptSubscriberInterface' => ['privates', 'SpecShaper\\EncryptBundle\\Subscribers\\DoctrineEncryptSubscriberInterface', 'getDoctrineEncryptSubscriberInterfaceService', true],
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ChoiceRepository' => ['privates', 'App\\Repository\\ChoiceRepository', 'getChoiceRepositoryService', true],
            'App\\Repository\\FollowRepository' => ['privates', 'App\\Repository\\FollowRepository', 'getFollowRepositoryService', true],
            'App\\Repository\\OptionBlocRepository' => ['privates', 'App\\Repository\\OptionBlocRepository', 'getOptionBlocRepositoryService', true],
            'App\\Repository\\ParcourRepository' => ['privates', 'App\\Repository\\ParcourRepository', 'getParcourRepositoryService', true],
            'App\\Repository\\SkillBlocRepository' => ['privates', 'App\\Repository\\SkillBlocRepository', 'getSkillBlocRepositoryService', true],
            'App\\Repository\\StudentRepository' => ['privates', 'App\\Repository\\StudentRepository', 'getStudentRepositoryService', true],
            'App\\Repository\\UeRepository' => ['privates', 'App\\Repository\\UeRepository', 'getUeRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\YearRepository' => ['privates', 'App\\Repository\\YearRepository', 'getYearRepositoryService', true],
        ], [
            'App\\Repository\\ChoiceRepository' => '?',
            'App\\Repository\\FollowRepository' => '?',
            'App\\Repository\\OptionBlocRepository' => '?',
            'App\\Repository\\ParcourRepository' => '?',
            'App\\Repository\\SkillBlocRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('sseb.encrypt', [0 => #[\Closure(name: 'SpecShaper\\EncryptBundle\\Subscribers\\EncryptEventSubscriber')] function () {
            return ($this->privates['SpecShaper\\EncryptBundle\\Subscribers\\EncryptEventSubscriber'] ?? $this->load('getEncryptEventSubscriberService'));
        }, 1 => 'encrypt'], 0);
        $instance->addListener('sseb.decrypt', [0 => #[\Closure(name: 'SpecShaper\\EncryptBundle\\Subscribers\\EncryptEventSubscriber')] function () {
            return ($this->privates['SpecShaper\\EncryptBundle\\Subscribers\\EncryptEventSubscriber'] ?? $this->load('getEncryptEventSubscriberService'));
        }, 1 => 'decrypt'], 0);
    ...
    /**
     * Gets the private 'SpecShaper\EncryptBundle\Encryptors\EncryptorInterface' shared autowired service.
     *
     * @return \SpecShaper\EncryptBundle\Encryptors\EncryptorInterface
     */
    protected function getEncryptorInterfaceService()
    {
        $a = ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService());

        if (isset($this->privates['SpecShaper\\EncryptBundle\\Encryptors\\EncryptorInterface'])) {
            return $this->privates['SpecShaper\\EncryptBundle\\Encryptors\\EncryptorInterface'];
        }

        return $this->privates['SpecShaper\\EncryptBundle\\Encryptors\\EncryptorInterface'] = (new \SpecShaper\EncryptBundle\Encryptors\EncryptorFactory($a))->createService($this->getEnv('resolve:ENCRYPT_KEY'));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('24LKVM02fw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CDTtMfOA47', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hN5rw0wdIO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BD1Y6tl6j9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('egm2ZpxJ-v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FMXysBGFWr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \SpecShaper\EncryptBundle\Twig\EncryptExtension(($this->privates['SpecShaper\\EncryptBundle\\Encryptors\\EncryptorInterface'] ?? $this->getEncryptorInterfaceService())));
    ...
    private $loadedDynamicParameters = [
        ...
        'spec_shaper_encrypt.encrypt_key' => false,
    ];
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'encrypt_key' => $this->getEnv('resolve:ENCRYPT_KEY'),
            ...
            'spec_shaper_encrypt.encrypt_key' => $this->getEnv('resolve:ENCRYPT_KEY'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SpecShaperEncryptBundle' => 'SpecShaper\\EncryptBundle\\SpecShaperEncryptBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'SpecShaperEncryptBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/specshaper/encrypt-bundle'),
            ...
            'spec_shaper_encrypt.method' => 'OpenSSL',
            'spec_shaper_encrypt.subscriber_class' => 'SpecShaper\\EncryptBundle\\Subscribers\\DoctrineEncryptSubscriber',
            'spec_shaper_encrypt.annotation_classes' => [
                0 => 'SpecShaper\\EncryptBundle\\Annotations\\Encrypted',
            ],
            'spec_shaper_encrypt.is_disabled' => false,
