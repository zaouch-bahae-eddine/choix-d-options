 ...
 */
class getUeRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/UeRepository.php';

        return $container->privates['App\\Repository\\UeRepository'] = new \App\Repository\UeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
