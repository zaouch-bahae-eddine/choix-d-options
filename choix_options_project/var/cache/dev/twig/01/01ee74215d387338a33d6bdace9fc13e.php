...
class __TwigTemplate_99234255c7b495bb56f3569e70d5d21c extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_student_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 39, $this->source); })()), "id", [], "any", false, false, false, 39)]), "html", null, true);
        echo "\">edit</a>
...
{% block body %}
    ...
    <a href=\"{{ path('app_student_edit', {'id': user.id}) }}\">edit</a>

    {{ include('student/_delete_form.html.twig') }}
{% endblock %}
", "student/show.html.twig", "/Users/etudiant/Desktop/prjthematique/choix-d-options/choix_options_project/templates/student/show.html.twig");
    }
}
