...
class __TwigTemplate_be4f2bcf869c71f35bbcd73357f05494 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
        ...
        <div class=\"login-description\">
            <h1>Choix d'opotions</h1>
            <h2>Master MIAGE</h2>
            <img src=\"";
        // line 49
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/upjv.png"), "html", null, true);
        echo "\" alt=\"logo-upjv\" width=\"220px\"/>
        </div>
...
";
    ...
    {
        return array (  155 => 66,  145 => 59,  140 => 56,  134 => 54,  132 => 53,  125 => 49,  119 => 45,  116 => 40,  106 => 8,  94 => 6,  89 => 5,  79 => 4,  60 => 3,  37 => 1,);
    }
...
{#<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            vous{{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
        </div>
    {% endif %}
   ...
   {# <button class=\"btn btn-lg btn-primary\" type=\"submit\">
    ...
    <div class=\"cont\">
        <div class=\"login-description\">
            <h1>Choix d'opotions</h1>
            <h2>Master MIAGE</h2>
            <img src=\"{{ asset('img/upjv.png') }}\" alt=\"logo-upjv\" width=\"220px\"/>
        </div>
        <div class=\"form sign-up\">
            <form method=\"post\">
                {% if error %}
...
{% endblock %}
", "security/login.html.twig", "/Users/etudiant/Desktop/prjthematique/choix-d-options/choix_options_project/templates/security/login.html.twig");
    }
}
